      ...
      <div className="bg-white shadow-sm border border-gray-100 rounded-xl mb-8 hover:shadow-md transition-all">
        <div className="px-6 py-5">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 mb-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">ID de la cuenta</label>
                ...
                <div className="relative flex items-stretch flex-grow">
                  ...
                  <button 
                    className={`inline-flex items-center px-3 py-2 border border-l-0 border-gray-200 rounded-r-md bg-gray-50 text-sm ${
                      copiedText === "id" ? "text-green-600" : "text-gray-500 hover:text-blue-500"
                    }`}
            ...
            <div>
              ...
              <input
                ...
                className="block w-full rounded-md bg-gray-50 border-gray-200 focus:ring-0 text-sm px-4 py-2.5 text-gray-600"
              />
            </div>
      ...
      <div className="bg-white shadow-sm border border-gray-100 rounded-xl hover:shadow-md transition-all">
        <div className="px-6 py-5">
          <div className="flex items-center mb-5">
            ...
            <h2 className="text-xl font-semibold text-gray-900">Token de acceso</h2>
          </div>
          ...
          <div className="mb-5">
            ...
            <div className="flex rounded-md shadow-sm">
              <div className="relative flex items-stretch flex-grow">
                ...
                <button
                  className={`inline-flex items-center px-3 py-2 border border-l-0 border-gray-200 rounded-r-md bg-gray-50 text-sm ${
                    copiedText === "token" ? "text-green-600" : "text-gray-500 hover:text-blue-500"
                  }`}
                  onClick={() => copyToClipboard("EAACkZCvCxZBtABAGJt5Wl8ZAP9NnvdgukK3DcmUcnPZA6yw6Y4r...", "token")}
                >
                  {copiedText === "token" ? (
                    <CheckIcon className="h-5 w-5" />
                  ) : (
            ...
            <p className="mt-2 text-sm text-gray-500 flex items-center">
              ...
              Este token se usa para autenticar tus solicitudes a la API de WhatsApp Business.
            </p>
          </div>
