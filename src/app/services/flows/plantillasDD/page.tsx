...
export default function ProjectsPage() {
  return (
    <div className="flex h-screen bg-gray-50">
      <FlowSidebar />
      <div className="flex-1 lg:ml-72 w-full"> {/* Changed to lg breakpoint */}
        <div className="
          px-7 py-12                         /* Móvil vertical */
          landscape:max-lg:px-7 
          landscape:max-lg:py-12  landscape:max-lg:px-7            /* Solo móvil horizontal */
        ...
        ">
          ...
          ">
            ...
            ">
              ...
              ">
                Gestiona tus proyectos con flujos predeterminados.
              </p>
            </div>
          </div>
          ...
          ">
            ...
            ">
              ...
              ">
                ...
                tus plantillas y flujos predeterminados desde aquí.
              </p>
            </div>
          </div>
        </div>
